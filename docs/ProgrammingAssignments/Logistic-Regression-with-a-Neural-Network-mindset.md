---
layout: post
title: Programming Assignment 1: Logistic Regression with a Neural Network mindset
---

# Course 1 - PA week 1: Logistic Regression with a Neural Network mindset
...
![]({{ "/ProgrammingAssignments/images/output_6_1.png" | absolute_url }})
...
![]({{ "/ProgrammingAssignments/images/LogReg_kiank.png" | absolute_url }})
...
#print("y = ", test_set_y[:, index], ", you predicted that it is a ", classes[d["Y_prediction_test"][0, index]].decode("utf-8"),  " picture.")
...
```
    ...
    <matplotlib.image.AxesImage at 0x7f6dbd0b8c18>




![]({{ "/ProgrammingAssignments/images/output_44_1.png" | absolute_url }})
...
![]({{ "/ProgrammingAssignments/images/output_46_0.png" | absolute_url }})
...
![]({{ "/ProgrammingAssignments/images/output_50_1.png" | absolute_url }})
...
# Code updated to use opencv (cv2) instead of PIL
```
...
![]({{ "/ProgrammingAssignments/images/output_53_1.png" | absolute_url }})
